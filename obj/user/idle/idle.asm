...
40000024:	68 34 0e 00 40       	push   $0x40000e34
...
4000004e:	68 40 0e 00 40       	push   $0x40000e40
...
40000078:	68 4c 0e 00 40       	push   $0x40000e4c
...
40000224:	e8 87 09 00 00       	call   40000bb0 <__udivdi3>
...
40000263:	e8 78 0a 00 00       	call   40000ce0 <__umoddi3>
40000268:	83 c4 08             	add    $0x8,%esp
4000026b:	57                   	push   %edi
4000026c:	0f be 80 58 0e 00 40 	movsbl 0x40000e58(%eax),%eax
...
400003a5:	ff 24 95 70 0e 00 40 	jmp    *0x40000e70(,%edx,4)
...
40000442:	75 05                	jne    40000449 <vprintfmt+0x14a>
				p = "(null)";
40000444:	bb 69 0e 00 40       	mov    $0x40000e69,%ebx
			if (width > 0 && padc != '-')
...
40000ae8:	83 ec 10             	sub    $0x10,%esp
    printf ("idle\n");
40000aeb:	68 c8 0f 00 40       	push   $0x40000fc8
40000af0:	e8 be f6 ff ff       	call   400001b3 <printf>

    pid_t ping_pid, pong_pid, ding_pid;

    if ((ping_pid = spawn (1, 1000)) != NUM_IDS)
40000af5:	83 c4 08             	add    $0x8,%esp
40000af8:	68 e8 03 00 00       	push   $0x3e8
40000afd:	6a 01                	push   $0x1
40000aff:	e8 14 fc ff ff       	call   40000718 <spawn>
40000b04:	83 c4 10             	add    $0x10,%esp
40000b07:	83 f8 40             	cmp    $0x40,%eax
40000b0a:	74 13                	je     40000b1f <main+0x45>
        printf ("ping in process %d.\n", ping_pid);
40000b0c:	83 ec 08             	sub    $0x8,%esp
40000b0f:	50                   	push   %eax
40000b10:	68 ce 0f 00 40       	push   $0x40000fce
40000b15:	e8 99 f6 ff ff       	call   400001b3 <printf>
40000b1a:	83 c4 10             	add    $0x10,%esp
40000b1d:	eb 10                	jmp    40000b2f <main+0x55>
    else
        printf ("Failed to launch ping.\n");
40000b1f:	83 ec 0c             	sub    $0xc,%esp
40000b22:	68 e3 0f 00 40       	push   $0x40000fe3
40000b27:	e8 87 f6 ff ff       	call   400001b3 <printf>
40000b2c:	83 c4 10             	add    $0x10,%esp

    if ((pong_pid = spawn (2, 1000)) != NUM_IDS)
40000b2f:	83 ec 08             	sub    $0x8,%esp
40000b32:	68 e8 03 00 00       	push   $0x3e8
40000b37:	6a 02                	push   $0x2
40000b39:	e8 da fb ff ff       	call   40000718 <spawn>
40000b3e:	83 c4 10             	add    $0x10,%esp
40000b41:	83 f8 40             	cmp    $0x40,%eax
40000b44:	74 13                	je     40000b59 <main+0x7f>
        printf ("pong in process %d.\n", pong_pid);
40000b46:	83 ec 08             	sub    $0x8,%esp
40000b49:	50                   	push   %eax
40000b4a:	68 fb 0f 00 40       	push   $0x40000ffb
40000b4f:	e8 5f f6 ff ff       	call   400001b3 <printf>
40000b54:	83 c4 10             	add    $0x10,%esp
40000b57:	eb 10                	jmp    40000b69 <main+0x8f>
    else
        printf ("Failed to launch pong.\n");
40000b59:	83 ec 0c             	sub    $0xc,%esp
40000b5c:	68 10 10 00 40       	push   $0x40001010
40000b61:	e8 4d f6 ff ff       	call   400001b3 <printf>
40000b66:	83 c4 10             	add    $0x10,%esp

    if ((ding_pid = spawn (3, 1000)) != NUM_IDS)
40000b69:	83 ec 08             	sub    $0x8,%esp
40000b6c:	68 e8 03 00 00       	push   $0x3e8
40000b71:	6a 03                	push   $0x3
40000b73:	e8 a0 fb ff ff       	call   40000718 <spawn>
40000b78:	83 c4 10             	add    $0x10,%esp
40000b7b:	83 f8 40             	cmp    $0x40,%eax
40000b7e:	74 13                	je     40000b93 <main+0xb9>
        printf ("ding in process %d.\n", ding_pid);
40000b80:	83 ec 08             	sub    $0x8,%esp
40000b83:	50                   	push   %eax
40000b84:	68 28 10 00 40       	push   $0x40001028
40000b89:	e8 25 f6 ff ff       	call   400001b3 <printf>
40000b8e:	83 c4 10             	add    $0x10,%esp
40000b91:	eb 10                	jmp    40000ba3 <main+0xc9>
    else
        printf ("Failed to launch ding.\n");
40000b93:	83 ec 0c             	sub    $0xc,%esp
40000b96:	68 3d 10 00 40       	push   $0x4000103d
40000b9b:	e8 13 f6 ff ff       	call   400001b3 <printf>
40000ba0:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000ba3:	b8 00 00 00 00       	mov    $0x0,%eax
40000ba8:	8b 4d fc             	mov    -0x4(%ebp),%ecx
40000bab:	c9                   	leave  
40000bac:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000baf:	c3                   	ret    

40000bb0 <__udivdi3>:
40000bb0:	55                   	push   %ebp
40000bb1:	57                   	push   %edi
40000bb2:	56                   	push   %esi
40000bb3:	53                   	push   %ebx
40000bb4:	83 ec 1c             	sub    $0x1c,%esp
40000bb7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
40000bbb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
40000bbf:	8b 4c 24 34          	mov    0x34(%esp),%ecx
40000bc3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000bc7:	85 f6                	test   %esi,%esi
40000bc9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000bcd:	89 ca                	mov    %ecx,%edx
40000bcf:	89 f8                	mov    %edi,%eax
40000bd1:	75 3d                	jne    40000c10 <__udivdi3+0x60>
40000bd3:	39 cf                	cmp    %ecx,%edi
40000bd5:	0f 87 c5 00 00 00    	ja     40000ca0 <__udivdi3+0xf0>
40000bdb:	85 ff                	test   %edi,%edi
40000bdd:	89 fd                	mov    %edi,%ebp
40000bdf:	75 0b                	jne    40000bec <__udivdi3+0x3c>
40000be1:	b8 01 00 00 00       	mov    $0x1,%eax
40000be6:	31 d2                	xor    %edx,%edx
40000be8:	f7 f7                	div    %edi
40000bea:	89 c5                	mov    %eax,%ebp
40000bec:	89 c8                	mov    %ecx,%eax
40000bee:	31 d2                	xor    %edx,%edx
40000bf0:	f7 f5                	div    %ebp
40000bf2:	89 c1                	mov    %eax,%ecx
40000bf4:	89 d8                	mov    %ebx,%eax
40000bf6:	89 cf                	mov    %ecx,%edi
40000bf8:	f7 f5                	div    %ebp
40000bfa:	89 c3                	mov    %eax,%ebx
40000bfc:	89 d8                	mov    %ebx,%eax
40000bfe:	89 fa                	mov    %edi,%edx
40000c00:	83 c4 1c             	add    $0x1c,%esp
40000c03:	5b                   	pop    %ebx
40000c04:	5e                   	pop    %esi
40000c05:	5f                   	pop    %edi
40000c06:	5d                   	pop    %ebp
...
40000c10:	39 ce                	cmp    %ecx,%esi
40000c12:	77 74                	ja     40000c88 <__udivdi3+0xd8>
40000c14:	0f bd fe             	bsr    %esi,%edi
40000c17:	83 f7 1f             	xor    $0x1f,%edi
40000c1a:	0f 84 98 00 00 00    	je     40000cb8 <__udivdi3+0x108>
40000c20:	bb 20 00 00 00       	mov    $0x20,%ebx
40000c25:	89 f9                	mov    %edi,%ecx
40000c27:	89 c5                	mov    %eax,%ebp
40000c29:	29 fb                	sub    %edi,%ebx
40000c2b:	d3 e6                	shl    %cl,%esi
40000c2d:	89 d9                	mov    %ebx,%ecx
40000c2f:	d3 ed                	shr    %cl,%ebp
40000c31:	89 f9                	mov    %edi,%ecx
40000c33:	d3 e0                	shl    %cl,%eax
40000c35:	09 ee                	or     %ebp,%esi
40000c37:	89 d9                	mov    %ebx,%ecx
40000c39:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000c3d:	89 d5                	mov    %edx,%ebp
40000c3f:	8b 44 24 08          	mov    0x8(%esp),%eax
40000c43:	d3 ed                	shr    %cl,%ebp
40000c45:	89 f9                	mov    %edi,%ecx
40000c47:	d3 e2                	shl    %cl,%edx
40000c49:	89 d9                	mov    %ebx,%ecx
40000c4b:	d3 e8                	shr    %cl,%eax
40000c4d:	09 c2                	or     %eax,%edx
40000c4f:	89 d0                	mov    %edx,%eax
40000c51:	89 ea                	mov    %ebp,%edx
40000c53:	f7 f6                	div    %esi
40000c55:	89 d5                	mov    %edx,%ebp
40000c57:	89 c3                	mov    %eax,%ebx
40000c59:	f7 64 24 0c          	mull   0xc(%esp)
40000c5d:	39 d5                	cmp    %edx,%ebp
40000c5f:	72 10                	jb     40000c71 <__udivdi3+0xc1>
40000c61:	8b 74 24 08          	mov    0x8(%esp),%esi
40000c65:	89 f9                	mov    %edi,%ecx
40000c67:	d3 e6                	shl    %cl,%esi
40000c69:	39 c6                	cmp    %eax,%esi
40000c6b:	73 07                	jae    40000c74 <__udivdi3+0xc4>
40000c6d:	39 d5                	cmp    %edx,%ebp
40000c6f:	75 03                	jne    40000c74 <__udivdi3+0xc4>
40000c71:	83 eb 01             	sub    $0x1,%ebx
40000c74:	31 ff                	xor    %edi,%edi
40000c76:	89 d8                	mov    %ebx,%eax
40000c78:	89 fa                	mov    %edi,%edx
40000c7a:	83 c4 1c             	add    $0x1c,%esp
40000c7d:	5b                   	pop    %ebx
40000c7e:	5e                   	pop    %esi
40000c7f:	5f                   	pop    %edi
40000c80:	5d                   	pop    %ebp
...
40000c88:	31 ff                	xor    %edi,%edi
40000c8a:	31 db                	xor    %ebx,%ebx
...
40000ca0:	89 d8                	mov    %ebx,%eax
40000ca2:	f7 f7                	div    %edi
40000ca4:	31 ff                	xor    %edi,%edi
40000ca6:	89 c3                	mov    %eax,%ebx
40000ca8:	89 d8                	mov    %ebx,%eax
40000caa:	89 fa                	mov    %edi,%edx
40000cac:	83 c4 1c             	add    $0x1c,%esp
40000caf:	5b                   	pop    %ebx
40000cb0:	5e                   	pop    %esi
40000cb1:	5f                   	pop    %edi
40000cb2:	5d                   	pop    %ebp
40000cb3:	c3                   	ret    
40000cb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000cb8:	39 ce                	cmp    %ecx,%esi
40000cba:	72 0c                	jb     40000cc8 <__udivdi3+0x118>
40000cbc:	31 db                	xor    %ebx,%ebx
40000cbe:	3b 44 24 08          	cmp    0x8(%esp),%eax
40000cc2:	0f 87 34 ff ff ff    	ja     40000bfc <__udivdi3+0x4c>
40000cc8:	bb 01 00 00 00       	mov    $0x1,%ebx
40000ccd:	e9 2a ff ff ff       	jmp    40000bfc <__udivdi3+0x4c>
40000cd2:	66 90                	xchg   %ax,%ax
40000cd4:	66 90                	xchg   %ax,%ax
40000cd6:	66 90                	xchg   %ax,%ax
40000cd8:	66 90                	xchg   %ax,%ax
40000cda:	66 90                	xchg   %ax,%ax
40000cdc:	66 90                	xchg   %ax,%ax
...
40000ce4:	83 ec 1c             	sub    $0x1c,%esp
40000ce7:	8b 54 24 3c          	mov    0x3c(%esp),%edx
40000ceb:	8b 4c 24 30          	mov    0x30(%esp),%ecx
40000cef:	8b 74 24 34          	mov    0x34(%esp),%esi
40000cf3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000cf7:	85 d2                	test   %edx,%edx
40000cf9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
40000cfd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000d01:	89 f3                	mov    %esi,%ebx
40000d03:	89 3c 24             	mov    %edi,(%esp)
40000d06:	89 74 24 04          	mov    %esi,0x4(%esp)
40000d0a:	75 1c                	jne    40000d28 <__umoddi3+0x48>
40000d0c:	39 f7                	cmp    %esi,%edi
40000d0e:	76 50                	jbe    40000d60 <__umoddi3+0x80>
40000d10:	89 c8                	mov    %ecx,%eax
40000d12:	89 f2                	mov    %esi,%edx
40000d14:	f7 f7                	div    %edi
40000d16:	89 d0                	mov    %edx,%eax
40000d18:	31 d2                	xor    %edx,%edx
40000d1a:	83 c4 1c             	add    $0x1c,%esp
40000d1d:	5b                   	pop    %ebx
40000d1e:	5e                   	pop    %esi
40000d1f:	5f                   	pop    %edi
40000d20:	5d                   	pop    %ebp
...
40000d28:	39 f2                	cmp    %esi,%edx
40000d2a:	89 d0                	mov    %edx,%eax
40000d2c:	77 52                	ja     40000d80 <__umoddi3+0xa0>
40000d2e:	0f bd ea             	bsr    %edx,%ebp
40000d31:	83 f5 1f             	xor    $0x1f,%ebp
40000d34:	75 5a                	jne    40000d90 <__umoddi3+0xb0>
40000d36:	3b 54 24 04          	cmp    0x4(%esp),%edx
40000d3a:	0f 82 e0 00 00 00    	jb     40000e20 <__umoddi3+0x140>
40000d40:	39 0c 24             	cmp    %ecx,(%esp)
40000d43:	0f 86 d7 00 00 00    	jbe    40000e20 <__umoddi3+0x140>
40000d49:	8b 44 24 08          	mov    0x8(%esp),%eax
40000d4d:	8b 54 24 04          	mov    0x4(%esp),%edx
40000d51:	83 c4 1c             	add    $0x1c,%esp
40000d54:	5b                   	pop    %ebx
40000d55:	5e                   	pop    %esi
40000d56:	5f                   	pop    %edi
40000d57:	5d                   	pop    %ebp
...
40000d60:	85 ff                	test   %edi,%edi
40000d62:	89 fd                	mov    %edi,%ebp
40000d64:	75 0b                	jne    40000d71 <__umoddi3+0x91>
40000d66:	b8 01 00 00 00       	mov    $0x1,%eax
40000d6b:	31 d2                	xor    %edx,%edx
40000d6d:	f7 f7                	div    %edi
40000d6f:	89 c5                	mov    %eax,%ebp
40000d71:	89 f0                	mov    %esi,%eax
40000d73:	31 d2                	xor    %edx,%edx
40000d75:	f7 f5                	div    %ebp
40000d77:	89 c8                	mov    %ecx,%eax
40000d79:	f7 f5                	div    %ebp
40000d7b:	89 d0                	mov    %edx,%eax
40000d7d:	eb 99                	jmp    40000d18 <__umoddi3+0x38>
40000d7f:	90                   	nop
40000d80:	89 c8                	mov    %ecx,%eax
40000d82:	89 f2                	mov    %esi,%edx
40000d84:	83 c4 1c             	add    $0x1c,%esp
40000d87:	5b                   	pop    %ebx
40000d88:	5e                   	pop    %esi
40000d89:	5f                   	pop    %edi
40000d8a:	5d                   	pop    %ebp
...
40000d90:	8b 34 24             	mov    (%esp),%esi
40000d93:	bf 20 00 00 00       	mov    $0x20,%edi
40000d98:	89 e9                	mov    %ebp,%ecx
40000d9a:	29 ef                	sub    %ebp,%edi
40000d9c:	d3 e0                	shl    %cl,%eax
40000d9e:	89 f9                	mov    %edi,%ecx
40000da0:	89 f2                	mov    %esi,%edx
40000da2:	d3 ea                	shr    %cl,%edx
40000da4:	89 e9                	mov    %ebp,%ecx
40000da6:	09 c2                	or     %eax,%edx
40000da8:	89 d8                	mov    %ebx,%eax
40000daa:	89 14 24             	mov    %edx,(%esp)
40000dad:	89 f2                	mov    %esi,%edx
40000daf:	d3 e2                	shl    %cl,%edx
40000db1:	89 f9                	mov    %edi,%ecx
40000db3:	89 54 24 04          	mov    %edx,0x4(%esp)
40000db7:	8b 54 24 0c          	mov    0xc(%esp),%edx
40000dbb:	d3 e8                	shr    %cl,%eax
40000dbd:	89 e9                	mov    %ebp,%ecx
40000dbf:	89 c6                	mov    %eax,%esi
40000dc1:	d3 e3                	shl    %cl,%ebx
40000dc3:	89 f9                	mov    %edi,%ecx
40000dc5:	89 d0                	mov    %edx,%eax
40000dc7:	d3 e8                	shr    %cl,%eax
40000dc9:	89 e9                	mov    %ebp,%ecx
40000dcb:	09 d8                	or     %ebx,%eax
40000dcd:	89 d3                	mov    %edx,%ebx
40000dcf:	89 f2                	mov    %esi,%edx
40000dd1:	f7 34 24             	divl   (%esp)
40000dd4:	89 d6                	mov    %edx,%esi
40000dd6:	d3 e3                	shl    %cl,%ebx
40000dd8:	f7 64 24 04          	mull   0x4(%esp)
40000ddc:	39 d6                	cmp    %edx,%esi
40000dde:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000de2:	89 d1                	mov    %edx,%ecx
40000de4:	89 c3                	mov    %eax,%ebx
40000de6:	72 08                	jb     40000df0 <__umoddi3+0x110>
40000de8:	75 11                	jne    40000dfb <__umoddi3+0x11b>
40000dea:	39 44 24 08          	cmp    %eax,0x8(%esp)
40000dee:	73 0b                	jae    40000dfb <__umoddi3+0x11b>
40000df0:	2b 44 24 04          	sub    0x4(%esp),%eax
40000df4:	1b 14 24             	sbb    (%esp),%edx
40000df7:	89 d1                	mov    %edx,%ecx
40000df9:	89 c3                	mov    %eax,%ebx
40000dfb:	8b 54 24 08          	mov    0x8(%esp),%edx
40000dff:	29 da                	sub    %ebx,%edx
40000e01:	19 ce                	sbb    %ecx,%esi
40000e03:	89 f9                	mov    %edi,%ecx
40000e05:	89 f0                	mov    %esi,%eax
40000e07:	d3 e0                	shl    %cl,%eax
40000e09:	89 e9                	mov    %ebp,%ecx
40000e0b:	d3 ea                	shr    %cl,%edx
40000e0d:	89 e9                	mov    %ebp,%ecx
40000e0f:	d3 ee                	shr    %cl,%esi
40000e11:	09 d0                	or     %edx,%eax
40000e13:	89 f2                	mov    %esi,%edx
40000e15:	83 c4 1c             	add    $0x1c,%esp
40000e18:	5b                   	pop    %ebx
40000e19:	5e                   	pop    %esi
40000e1a:	5f                   	pop    %edi
40000e1b:	5d                   	pop    %ebp
...
40000e20:	29 f9                	sub    %edi,%ecx
40000e22:	19 d6                	sbb    %edx,%esi
40000e24:	89 74 24 04          	mov    %esi,0x4(%esp)
40000e28:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e2c:	e9 18 ff ff ff       	jmp    40000d49 <__umoddi3+0x69>
