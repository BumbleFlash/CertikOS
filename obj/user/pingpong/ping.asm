...
40000b15:	6a 64                	push   $0x64
40000b17:	68 ac 0f 00 40       	push   $0x40000fac
40000b1c:	e8 92 f6 ff ff       	call   400001b3 <printf>
    *addr = val;
40000b21:	c7 05 00 00 00 e0 64 	movl   $0x64,0xe0000000
40000b28:	00 00 00 
    yield();
40000b2b:	e8 07 fc ff ff       	call   40000737 <yield>
    printf("ping: the new value at address %x: %d\n", addr, *addr);
40000b30:	83 c4 0c             	add    $0xc,%esp
40000b33:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000b39:	68 00 00 00 e0       	push   $0xe0000000
40000b3e:	68 dc 0f 00 40       	push   $0x40000fdc
40000b43:	e8 6b f6 ff ff       	call   400001b3 <printf>
40000b48:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000b4b:	b8 00 00 00 00       	mov    $0x0,%eax
40000b50:	8b 4d fc             	mov    -0x4(%ebp),%ecx
40000b53:	c9                   	leave  
40000b54:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000b57:	c3                   	ret    
40000b58:	66 90                	xchg   %ax,%ax
40000b5a:	66 90                	xchg   %ax,%ax
40000b5c:	66 90                	xchg   %ax,%ax
